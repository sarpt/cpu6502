...
pub fn and(cpu: &mut CPU, addr_mode: AddressingMode) -> Tasks {
...
pub fn bit_zp(cpu: &mut CPU) -> Tasks {
    return bit(cpu, AddressingMode::ZeroPage);
}

pub fn bit_a(cpu: &mut CPU) -> Tasks {
